...
def bold_hazard(text):
    ...
    # Highlight Winter Hazards + Fog, Ignore RA/DZ
...
# 7. BACKGROUND FETCH (WINTER HAZARD SCAN)
        ...
        try:
            ...
            if t.data:
                for line in t.data.forecast:
                    ...
                    # TRIGGER ONLY ON SPECIFIC HAZARDS
...
for iata, info in base_airports.items():
    ...
    # CRITICAL: INITIALIZE ALL POPUP VARIABLES TO PREVENT CRASH
    v_lim, c_lim = (1500, 500) if info['spec'] else (800, 200)
...
st_folium(m, width=1200, height=1200, key="map_v190")
