...
with st.sidebar:
    ...
    if st.session_state.investigate_iata != "None":
        ...
        st.markdown(f"""
        <div style="background-color: white; padding: 15px; border-radius: 8px; color: #002366; margin-bottom: 15px;">
...
# 9. INJECT ALERT BUTTONS INTO THE SIDEBAR
