...
# 6. SIDEBAR (RESTORED X-WIND TABLE)
with st.sidebar:
...
st_folium(m, width=1000, height=1000, key="map_v140")
...
if st.session_state.investigate_iata != "None":
    ...
    elif "X-WIND" in issue_desc: impact = "Critical crosswind (>=25kt). Verify runway state."
