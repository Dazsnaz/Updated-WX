...
def bold_hazard(text):
    ...
    text = re.sub(r'(\b(FG|TSRA|SN|FOG|FZRA|FZDZ)\b)', r'<b>\1</b>', text)
    return text
...
base_airports = {
    ...
    "SSH": {"icao": "HESH", "lat": 27.977, "34.394": 34.394, "rwy": 40, "fleet": "Euroflyer", "spec": False},
    "PFO": {"icao": "LCPH", "lat": 34.718, "lon": 32.486, "rwy": 290, "fleet": "Euroflyer", "spec": False},
    "LCA": {"icao": "LCLK", "lat": 34.875, "33.625": 33.625, "rwy": 220, "fleet": "Euroflyer", "spec": False},
...
# Placeholder for processing logic (RAG Status, Strategy Briefs, Handover Log)
# As per original v29.2, this would continue with map generation and alert tabs.
