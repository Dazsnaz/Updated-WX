...
st.markdown("""
    ...
    .stButton > button { 
        ...
        height: 52px !important; /* Reduced height for horizontal rectangle shape */
...
base_airports = {
    ...
    "JER": {"icao": "EGJJ", "lat": 49.208, "code": "JER", "lon": -2.195, "rwy": 260, "fleet": "Euroflyer", "spec": False},
...
st_folium(m, width=1000, height=1000, key="map_v123")
