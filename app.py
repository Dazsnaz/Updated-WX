...
# 2. HUD STYLING (V14.2 STABLE BASE + VISIBILITY PATCH)
st.markdown("""
    <style>
    ...
    /* STRATEGY BRIEF VISIBILITY FIX (Force Navy Text) */
...
st_folium(m, width=1200, height=1200, key="map_strategy_fix")
...
# 11. STRATEGY BRIEF (RE-ALIGNED & VISIBILITY FIXED)
